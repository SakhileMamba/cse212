...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The test was failing because people were being added at the beginning of a queue instead of the end in the person queue
    ...
    // Defect(s) Found: Person that start with more than on turn were being re enqueued after they got down to 0 turn.
